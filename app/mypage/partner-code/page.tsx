...
export default function PartnerCodePage() {
  ...
  const getShareText = () => {
    ...
    return `라우브필름에서 할인된 가격으로 본식DVD를 만나보세요!
                  ...
                  {data.referrals.map((r) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-muted-foreground">
                        {r.weddingDate ? new Date(r.weddingDate).toLocaleDateString('ko-KR') : '날짜 미정'} 예식
                      </span>
                    </div>
                  ))}
                </div>
