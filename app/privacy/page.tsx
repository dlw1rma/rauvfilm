    ...
    <div className="min-h-screen py-20 px-4">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
          <p className="mb-6">
            라우브필름(이하 '회사'라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
          </p>

          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제1조 (개인정보의 처리목적)</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제2조 (개인정보의 처리 및 보유기간)</h2>
            <p className="mb-2">
            ...
            <ol className="list-decimal pl-6 space-y-3 mt-2">
              <li>
                <strong>홈페이지 예약글 작성 및 고객 관리 : 계약일로 부터 4년</strong><br />
                다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지
                <ol className="list-decimal pl-6 mt-1 space-y-1">
                  <li>관계 법령 위반에 따른 수사, 조사 등이 진행 중인 경우에는 해당 수사, 조사 종료 시까지</li>
                  <li>본식 촬영 계약에 따른 채권 및 채무관계 잔존 시에는 해당 채권, 채무 관계 정산 시까지</li>
                </ol>
              </li>
              <li>
                <strong>서비스 제공 : 서비스 공급완료 및 정산 완료 시까지</strong><br />
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제3조 (개인정보의 제3자 제공)</h2>
            <p className="mb-2">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-2">
              <li>개인정보를 제공받는 자 : 라우브필름 제휴사</li>
              <li>제공받는 자의 개인정보 이용목적 : 제휴사 고객관리 및 예약관리, 고충해결</li>
              <li>제공하는 개인정보 항목 : 예식자이름(신랑,신부), 휴대폰번호(신랑, 신부), 이메일, 예약자 성함, 본식 관련 정보(예식장, 날짜, 시간)</li>
              <li>제공받는 자의 보유, 이용기간 : 제휴 상품 제공 이후 고충 처리 완료 후까지</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제5조(정보주체 및 법정대리인의 권리와 그 행사 방법)</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제6조(처리하는 개인정보 항목)</h2>
            <p className="mb-2">회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
            <ol className="list-decimal pl-6 space-y-2 mt-2">
              <li>
                <strong>재화 또는 서비스 제공</strong><br />
                필수항목 : 이름, 휴대폰번호, 이메일, 예약자 성함, 예식자이름(신랑,신부), 자택주소
              </li>
            </ol>
          </section>

          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제7조(개인정보의 파기)</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제8조(개인정보의 안전성 확보조치)</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제9조(개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제10조(개인정보 보호책임자)</h2>
            <p className="mb-2">
            ...
            <div className="mt-4 space-y-3">
              <div>
                ...
                <ul className="list-none space-y-1 pl-4">
                  <li>성명 : 손세한</li>
                  <li>직책 : 대표감독</li>
                  <li>연락처 : rauvfilm@naver.com</li>
                  <li>※ 개인정보 보호 담당부서로 연결됩니다.</li>
                </ul>
              </div>
              <div>
                <p className="font-semibold mb-2">▶ 개인정보 보호 담당자</p>
                <ul className="list-none space-y-1 pl-4">
                  <li>성명 : 손세한</li>
                  <li>직책 : 대표감독</li>
                  <li>연락처 : rauvfilm@naver.com</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제11조(개인정보 열람청구)</h2>
            <p className="mb-2">
              정보주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. 회사는 정보주체의 개인정보 열람 청구가 신속하게 처리되도록 노력하겠습니다.
            </p>
            <div className="mt-4">
              <p className="font-semibold mb-2">▶ 개인정보 열람청구 접수․처리 담장자</p>
              <ul className="list-none space-y-1 pl-4">
                <li>성명 : 손세한</li>
                <li>직책 : 대표감독</li>
                <li>연락처 : rauvfilm@naver.com</li>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제12조(권익침해 구제 방법)</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">제13조(개인정보 처리방침 시행 및 변경)</h2>
            <p>이 개인정보 처리방침은 2024. 04. 15. 부터 적용됩니다.</p>
          </section>
        </div>
      </div>
    </div>
