...
export default function CustomClient() {
  ...
  const [resultData, setResultData] = useState<FormData | null>(null);
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-5 mb-6">
            ...
            <div className="bg-[#252525] p-6 rounded-xl border-l-4 border-[#ff4757]">
              ...
              <div className="text-[#ddd] space-y-2 text-sm leading-relaxed">
                <p>
                  <strong>날짜:</strong> {resultData.weddingDate}
                </p>
                <p>
                  <strong>시간:</strong> {resultData.weddingTime}
                </p>
                <p>
                  <strong>장소:</strong> {resultData.venue}
                </p>
                <p>
                  <strong>신랑:</strong> {resultData.groomName} <strong>신부:</strong> {resultData.brideName}
                </p>
              </div>
            </div>
          ...
          <button
            onClick={resetForm}
            className="w-full py-4 bg-transparent text-[#ff4757] border-2 border-[#ff4757] rounded-xl text-base font-bold cursor-pointer transition-all hover:bg-[#ff4757] hover:text-white"
          >
            새로운 신청서 작성하기
          </button>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#e0e0e0] text-sm md:text-base leading-relaxed">
            특별한 날 원하시는 영상으로 받아보세요!
          </p>
        </div>

        {/* Info Box */}
        <div className="bg-[rgba(255,71,87,0.1)] border-l-4 border-[#ff4757] p-5 md:p-6 rounded-lg mb-8">
          <p className="text-[#ddd] text-sm md:text-base leading-relaxed">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div>
            <div className="flex items-center mb-5">
              <div className="text-lg md:text-xl font-bold text-white">📅 예식 정보</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
              <DateInput
                ...
                className="px-4 py-4 bg-[#252525] border-2 border-[#2a2a2a] rounded-lg text-base text-white transition-all focus:outline-none focus:border-[#ff4757] focus:bg-[#2a2a2a]"
              />
              <TimeInput
                name="weddingTime"
                required
          ...
          {checkboxGroups.map((group) => (
            <div key={group.name}>
              <div className="flex items-center mb-5">
                <div className="text-lg md:text-xl font-bold text-white">{group.label}</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {group.options.map((option) => {
                  const isChecked = selectedCheckboxes[group.name] === option.id;
                  return (
                    <div
                      key={option.id}
          ...
          <div>
            <div className="flex items-center mb-5">
              <div className="text-lg md:text-xl font-bold text-white">💝 특별 요청사항</div>
            </div>
            <textarea
              id="specialRequest"
          ...
          <button
            ...
            className="w-full py-5 bg-gradient-to-r from-[#ff4757] to-[#ff6b81] text-white border-none rounded-xl text-lg font-bold cursor-pointer transition-all mt-8 tracking-wide hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(255,71,87,0.4)] active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed"
          >
