...
function getSourceLabel(sourceType: string, t: any) {
  switch (sourceType) {
    case "naver_blog":
      return t.review.naverBlog;
    case "naver_cafe":
      return t.review.naverCafe;
    case "instagram":
      return t.review.instagram;
    default:
      return t.review.reviewLabel;
  }
}
...
export default async function ReviewsPage({
  ...
  const subtitleLines = t.review.subtitle.split("\n");
    ...
    <div className="min-h-screen py-20 px-4">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          <h1 className="mb-4 text-4xl font-bold">{t.review.title}</h1>
              ...
              <div className="p-5">
                <div className="mb-3">
                  <span className="rounded-full bg-accent/10 px-3 py-1 text-xs font-medium text-accent">
                    {getSourceLabel(review.sourceType, t)}
                  </span>
                </div>
                ...
                <p className="mt-3 text-xs text-muted-foreground">
                  - {review.author || t.review.anonymous}
                </p>
              </div>
            </a>
          ))}
